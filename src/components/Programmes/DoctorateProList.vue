<template>
  <div class="doc-pro-list">
    <v-row class="fill-height pa-0 mb-4" align="center" justify="center">
      <v-col cols="10" md="10">
...
<script>
export default {
  name: 'DoctorateProList',
  data() {
    return {
      dialog: false,
      phd: [
        { text: 'Ph.D Tamil' },
        { text: 'Ph.D Management' },
        { text: 'Ph.D Project Management' },
      ],
      dba: [{ text: 'Doctorate of Business Administration' }],
      dpe: [{ text: 'Doctorate of Professional Entrepreneurship' }],
    };
  },
};
</script>
